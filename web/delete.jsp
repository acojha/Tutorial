<%-- 
    Document   : delete
    Created on : Dec 15, 2019, 7:37:22 PM
    Author     : OJHA
--%>
        ...
        <div style="padding-left:66px; color:#4CAF50;">
            ...
            <form method=post" action="StudentController">
                ...
                <table border="0" cellspacing="0" cellpadding="5">
                    <tr><td>Name</td><td><input type="text" name="sname" value="<%=aStudent.getSname()%>" readonly></td></tr>
                    <tr><td>Roll No</td><td><input type="text" name="rollno" value="<%=aStudent.getRollno()%>" readonly></td></tr>
                    <tr><td>Semester</td>
                        <td><select name="semester" readonly>
                    ...
                    <tr><td colspan="2" align="center"><input type="submit" value="Confirm Delete"></tr>
                </table>
            </form>
            <%
                }
